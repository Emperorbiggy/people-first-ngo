...
export default function PaidApplicants({ history = [], stats = {} }) {
    ...
    return (
        <AdminLayout title="Paid Applicants">
            <div className="max-w-7xl mx-auto space-y-6">

                <div>
                    <h1 className="text-xl font-bold text-gray-800">Paid Applicants</h1>
                    <p className="text-sm text-gray-500 mt-0.5">All applicant payment attempts processed via Paystack.</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    {history.length === 0 ? (
                        <div className="py-16 text-center">
                            <p className="text-gray-400 text-sm">No applicant payments have been made yet.</p>
                        </div>
                    ) : filtered.length === 0 ? (
