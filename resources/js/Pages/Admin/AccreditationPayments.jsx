                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="px-5 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center gap-3">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                placeholder="Search by name, LGA, or databoy…"
                                value={search}
                    ...
                    {history.length === 0 ? (
                        <div className="py-16 text-center">
                            <p className="text-gray-400 text-sm">No accreditation payments have been made yet.</p>
                        </div>
                    ) : filtered.length === 0 ? (
                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {filtered.map((h) => (
                                        <tr key={h.id} className="hover:bg-indigo-50/30 transition-colors">
                                            ...
                                            <td className="px-5 py-3 text-sm text-gray-600 whitespace-nowrap">{h.databoy}</td>
