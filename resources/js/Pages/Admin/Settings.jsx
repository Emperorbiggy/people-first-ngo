    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            ...
            <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Not automatic — pay databoys who accredited someone from the "Pay Databoys" page. Each databoy is paid once, ever, no matter how many days they work.</p>
            </div>
            <div>
