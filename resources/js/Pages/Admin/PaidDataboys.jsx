...
export default function PaidDataboys({ history = [], stats = {} }) {
    ...
    return (
        <AdminLayout title="Paid Databoys">
            <div className="max-w-7xl mx-auto space-y-6">

                <div>
                    <h1 className="text-xl font-bold text-gray-800">Paid Databoys</h1>
                    <p className="text-sm text-gray-500 mt-0.5">All databoy payment attempts processed via Paystack.</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    {history.length === 0 ? (
                        <div className="py-16 text-center">
                            <p className="text-gray-400 text-sm">No databoy payments have been made yet.</p>
                        </div>
                    ) : filtered.length === 0 ? (
