                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            <div className="mb-8">
                                <Link
                                    href={route('ngo-contract-applications.create')}
                                    className="flex items-center justify-center gap-4 rounded-lg bg-green-600 p-8 shadow-lg transition duration-300 hover:bg-green-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
                                >
                                    ...
                                    <div className="text-center">
                                        <h2 className="text-2xl font-bold text-white">
                                            NGO Contract Work Application Form
                                        </h2>
                                        <p className="mt-2 text-green-100">
                                            Apply for NGO contract work opportunities
                                        </p>
                                    </div>
                                </Link>
                            </div>
