                ...
                <form ref={formRef} onSubmit={submit}
                    ...
                    <div className="p-5 space-y-5">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 pt-1 border-t border-gray-50">
                            ...
                            <PhotoCaptureField label="Photo of vehicle" file={data.vehicle_photo} error={errors.vehicle_photo}
                                existing={editing?.vehicle_photo_url}
                                onPick={(file) => setData('vehicle_photo', file)}
                                onClear={() => setData('vehicle_photo', null)} />
                            <PhotoCaptureField label="Photo of owner" file={data.owner_photo} error={errors.owner_photo}
