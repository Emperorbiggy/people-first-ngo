...
function CaptureModal({ application, onClose }) {
    ...
    const handleSave = () => {
        ...
        setSaving(true);
        setError('');
        router.post(route('databoy.accreditation.accredit', application.id), { photo: capturedFile }, {
            forceFormData: true,
            onSuccess: () => onClose(),
    ...
    return (
        <DataboyLayout title="Accreditation">
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-0.5">Search the applicants you registered, take their photo, and mark them as accredited.</p>
            </div>
