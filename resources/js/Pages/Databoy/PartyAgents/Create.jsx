        ...
        <DataboyLayout title="Not Active">
            <div className="min-h-[60vh] flex items-center justify-center p-6">
                <div className="max-w-md w-full text-center space-y-5">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-800">Party Agent Registration Disabled</h2>
                        <p className="text-sm text-gray-500 mt-2">
                            Party agent registration has been temporarily disabled by the admin. Please check back later.
                        </p>
                    </div>
                    <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-sm text-amber-800">
                        Contact admin to enable party agent registration.
                    </div>
                </div>
            </div>
        </DataboyLayout>
            ...
            <div className="min-h-[60vh] flex items-center justify-center p-6">
                <div className="max-w-md w-full text-center space-y-5">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-2">
                            You do not have a ward assigned yet. Contact the admin to assign your ward before you can register party agents.
                        </p>
                    </div>
...
export default function Create({ accessEnabled = true }) {
    ...
    useEffect(() => {
        ...
        setLoadingPUs(true);
        axios.get(route('databoy.party-agents.api.polling-units', { ward: databoy.ward_id }))
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('databoy.party-agents.store'), { forceFormData: true });
    };

    return (
        <DataboyLayout title="Add Party Agent">
            <div className="max-w-2xl mx-auto">
                <div className="mb-6">
                    <h1 className="text-xl font-bold text-gray-800">Add Party Agent</h1>
                    <p className="text-sm text-gray-500 mt-0.5">Register a party agent for your ward.</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <Section title="Personal Information">
                        <div>
                            ...
                            <input type="text" value={data.full_name} onChange={(e) => setData('full_name', e.target.value)}
                                placeholder="Enter full name as it appears on their ID" className={inputCls} />
                    ...
                    <Section title="Location (LGA, Ward &amp; Polling Unit)">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            ...
                            <span className="text-sm text-gray-700">Party agent has a Voter's Card</span>
                        </label>
                    </Section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="tel" value={data.browsing_number}
                                    ...
                                    placeholder="Browsing network number" className={inputCls} />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" value={data.current_occupation}
                                        ...
                                        placeholder="Current occupation" className={inputCls} />
                                </div>
                    ...
                    {/* Passport only — no ID card or certificate for party agents */}
                            ...
                            <div className="flex gap-2 mb-3">
                                ...
                                <label className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-xl transition cursor-pointer">
                                    ...
                                    <input ref={passportRef} type="file" accept=".jpg,.jpeg,.png" className="hidden"
                                        onChange={(e) => handleFile('passport_photograph', e.target.files[0])} />
                                </label>
                            </div>
                    ...
                    >
                        {processing ? 'Submitting…' : 'Register Party Agent'}
                    </button>
                </form>
            </div>
        </DataboyLayout>
